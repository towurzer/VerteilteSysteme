document.getElementById('emailForm').addEventListener('submit', async (e) => { // Execute that function asynchronous when the "emailForm" is submitted
    ...
    const delay = formData.get('delay'); // extract values
